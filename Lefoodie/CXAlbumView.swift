...
public protocol CXAlbumViewDelegate:class{
...
final class CXAlbumView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, PHPhotoLibraryChangeObserver, UIGestureRecognizerDelegate {
    ...
    weak var delegate: CXAlbumViewDelegate? = nil
    ...
    let imageCropViewMinimalVisibleHeight: CGFloat  = 0//100
    ...
    static func instance() -> CXAlbumView {
        
        return UINib(nibName: "CXAlbumView", bundle: Bundle(for: self.classForCoder())).instantiate(withOwner: self, options: nil)[0] as! CXAlbumView
    }
    ...
    func initialize() {
        ...
        let panGesture      = UIPanGestureRecognizer(target: self, action: #selector(CXAlbumView.panned(_:)))
        ...
        collectionView.register(UINib(nibName: "CXAlbumCollectionViewCell", bundle: Bundle(for: self.classForCoder)), forCellWithReuseIdentifier: "CXAlbumCollectionViewCell")
        collectionView.backgroundColor = CXBackgroundColor
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CXAlbumCollectionViewCell", for: indexPath) as! CXAlbumCollectionViewCell
